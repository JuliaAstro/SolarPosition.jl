...
```@raw html
<details><summary><i>Accuracy comparison </i></summary>
```
...
```@raw html
<details><summary><i>Data collection</i></summary>
```
...
algo_stats = algo_stats[indexing(algo_order, algo_stats.Algorithm), :]
...
```@raw html
<details><summary><i>single benchmark code</i></summary>
```
...
```@raw html
<details><summary><i>vector benchmark code</i></summary>
```
...
```@raw html
<details><summary><i>Benchmark code</i></summary>
```
