...
algorithm and solar positions are differentiable with ForwardDiff. See the
[Automatic Differentiation](@ref automatic-differentiation) guide for gradients,
panel orientation optimization, and a single axis tracker example.
