...
const DELTAT_TABLE = (
    ...
    (
        ...
        y -> begin
            u = y / 100.0
            p = (10583.6, -1014.41, 33.78311, -5.952053, -0.1798452, 0.022174192, 0.0090316521)
            evalpoly(u, p)
        end,
    ),
    (
        ...
        y -> begin
            u = (y - 1000.0) / 100.0
            p = (1574.2, -556.01, 71.23472, 0.319781, -0.8503463, -0.005050998, 0.0083572073)
            evalpoly(u, p)
        end,
    ),
    ...
    (
        ...
        y -> begin
            t = y - 1800.0
            p = (13.72, -0.332447, 0.0068612, 0.0041116, -0.00037436, 0.0000121272, -0.0000001699, 0.000000000875)
            evalpoly(t, p)
        end,
    ),
    (
